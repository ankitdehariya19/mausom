...
const MausonLoader: React.FC = () => {
  ...
  return (
    <div className='w-full h-screen bg-white max-w-7xl  z-50'>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-50 flex justify-center items-center  ">
        ...
        <div className="absolute w-full max-w-7xl mx-auto bg-black top-24 left-0 right-0 bottom-0 flex flex-col items-center justify-center z-40">
